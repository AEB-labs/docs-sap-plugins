...
[block:parameters]
{
  "data": {
    "h-0": "Requirement",
    "h-1": "Function module / Class",
    "0-0": "Read certain data from the result of an export controls check. ( for a single item of a transaction)",
    "0-1": "/AEB/CL_CMP_PB_EC_DATA_READ_BC",
    "1-0": "Read the approval and clearing data for the items of a document.  \nThe parameters IM_ORG_UNIT and IM_ENGN_CALL_PARAMS are optional. Both parameters will be determined by the functions itself if left empty.  \nThe fields VBELN and POSNR of parameter IM_REQUESTS are deprecated. Use instead the fields DOC_NO and ITEM_REF_ID of the same structure. <br>  \nNote: This function calls a web service when executed.",
    "1-1": "/AEB/CMP_PB_EC_GET_CLEA_FOR",
    "2-0": "Read the history of comments that have been entered when an item was released.",
    "2-1": "/AEB/CMP_PB_EC_GET_HISTORY_FOR",
    "3-0": "Read the data for a questionnaire created by an export controls check.",
    "3-1": "/AEB/CL_CMP_PB_QUEST_BC",
    "4-0": "Read further informations about the license.  \n**Hint**: The function works only for licenses from license management (LM). But it cannot  be used for the general licenses from export controls. (meaning the licenses from the data service). <br>  \nNote: This function calls a web service when executed.",
    "4-1": "/AEB/CL_CMP_PB_EC_LIC_INFO_BC"
  },
  "cols": 2,
  "rows": 5,
  "align": [
