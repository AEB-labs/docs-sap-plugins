...
<Callout icon="📘" theme="info">
  These functions only carry out a simple screening check and return just a boolean ( true / false) whether the business object is rated as critical (match). However, this does not set any locks in the business object and no entries are created in the Compliance Monitor.
</Callout>
