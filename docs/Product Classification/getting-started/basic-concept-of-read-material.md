...
next:
  description: >-
    Would like to know how to read some data for a material? Or try to adapt the
    data which is transferred for a material?
  pages:
    - type: basic
      slug: reading-al-and-eccn-number-for-material
      title: Read data from Material
    - type: basic
