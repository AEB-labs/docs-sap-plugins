...
4. Copy the following code block into a report and execute it in your system. The output of the report will inform you about the next steps.
   ```Text Report code
   CONSTANTS:
...
5. Manually move the objects to another package.
